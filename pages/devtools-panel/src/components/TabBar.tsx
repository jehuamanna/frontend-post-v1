...
export const TabBar: React.FC<TabBarProps> = ({
  ...
  return (
    <div className="flex items-center border-b border-gray-300 px-2 py-1.5 bg-white">
      <div
        ...
        {tabs.map((tab, index) => {
          ...
          return (
            <div
              ...
              className={`group relative flex items-center gap-1.5 px-2 py-1.5 text-xs rounded transition-colors ${onTabReorder ? 'cursor-move' : 'cursor-pointer'
                } ${isActive
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                {!tab.isLoading && tab.data.response && (
                  <div className={`w-2 h-2 rounded-full ${tab.data.response.status >= 200 && tab.data.response.status < 300
                      ? 'bg-green-500'
